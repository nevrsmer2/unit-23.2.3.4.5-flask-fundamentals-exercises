from survey_classes import Question, Survey

# Contains instances of the classes Survey and Question
# Instances of the class Question are instantiated  when an argument is passed in to the paramater 'questions' on an instance of the class Survey
